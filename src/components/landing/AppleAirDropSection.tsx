  ...
  return (
    <section id="airdrop" className="relative py-20 md:py-32 bg-[#09090b] overflow-hidden select-none">
      <div className="mx-auto max-w-[1040px] px-4 sm:px-6 lg:px-8">
        ...
        <div className="rounded-[36px] bg-zinc-900/60 border border-white/[0.08] p-6 sm:p-12 max-w-4xl mx-auto shadow-2xl">
          <div className="grid grid-cols-1 md:grid-cols-11 gap-6 items-center">
            {/* Left Device: Sender (iPhone 16 Pro) */}
            <div className="md:col-span-4 rounded-3xl bg-zinc-800/80 p-6 shadow-sm border border-white/[0.08] flex flex-col items-center text-center space-y-4">
              <div className="w-14 h-14 rounded-2xl bg-zinc-900 flex items-center justify-center text-white">
              ...
              <div>
                ...
                <h4 className="text-base font-bold text-white">iPhone 16 Pro (iOS)</h4>
              </div>

              {/* Sample File Card */}
              <div className="w-full p-3 rounded-2xl bg-zinc-900 flex items-center gap-3 text-left">
                ...
                <div className="min-w-0 flex-1">
                  <div className="text-xs font-bold text-white truncate">Cinematic_4K_ProRes.mov</div>
                  <div className="text-[10px] text-zinc-400">1.8 GB · 4K 60fps Dolby Vision</div>
                </div>
              </div>

              <div className="w-full text-[11px] font-medium text-blue-400 bg-blue-500/15 py-1.5 rounded-xl">
            ...
            <div className="md:col-span-3 flex flex-col items-center justify-center gap-3 py-4 md:py-0">
              {transferState === "idle" && (
                <button
                  onClick={startDemo}
                  className="inline-flex items-center gap-2 rounded-full bg-[#0071e3] px-5 py-2.5 text-xs font-semibold text-white shadow-md hover:bg-[#0077ed] active:scale-95 transition-all cursor-pointer"
                >
              ...
              {transferState === "streaming" && (
                <div className="w-full text-center space-y-2">
                  ...
                  <div className="h-2 w-full bg-zinc-900 rounded-full overflow-hidden p-0.5 border border-white/[0.08]">
                    <div
                      className="h-full bg-[#0071e3] rounded-full transition-all duration-150"
                      style={{ width: `${streamProgress}%` }}
                    />
                  </div>
                  <div className="text-[10px] text-zinc-400">{streamProgress}%</div>
                </div>
              )}

              {transferState === "complete" && (
                <div className="flex flex-col items-center gap-2">
                  <span className="inline-flex items-center gap-1.5 text-xs font-bold text-emerald-400 bg-emerald-500/20 px-3 py-1 rounded-full">
            ...
            <div className="md:col-span-4 rounded-3xl bg-zinc-800/80 p-6 shadow-sm border border-white/[0.08] flex flex-col items-center text-center space-y-4">
              ...
              <div>
                ...
                <h4 className="text-base font-bold text-white">Dell XPS 15 (Windows)</h4>
              </div>
              ...
              <div className="w-full text-[11px] font-medium text-zinc-300 bg-zinc-900 py-1.5 rounded-xl">
