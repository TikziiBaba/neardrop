...
export const AppleHighlights: React.FC = () => {
  ...
  return (
    <section id="highlights" className="relative py-20 md:py-32 bg-[#f5f5f7] select-none">
      <div className="mx-auto max-w-[1040px] px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-14 sm:mb-20">
          ...
          <h2 className="mt-2 text-3xl sm:text-5xl font-bold tracking-[-0.03em] text-[#1d1d1f]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <div className="md:col-span-7 rounded-[28px] border border-black/[0.06] bg-white p-8 sm:p-10 shadow-[0_10px_30px_rgba(0,0,0,0.04)] flex flex-col justify-between overflow-hidden relative group">
            <div className="space-y-2 z-10">
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-blue-50 text-[11px] font-semibold text-[#0071e3]">
            ...
            <div className="mt-8 pt-6 border-t border-black/[0.06] z-10">
              <div className="space-y-4">
                <div>
                  ...
                  <div className="h-3 w-full bg-[#f5f5f7] rounded-full overflow-hidden p-0.5">
                    <div className="h-full bg-gradient-to-r from-[#0071e3] to-[#34c759] rounded-full w-[95%] transition-all duration-500" />
                  </div>
                </div>

                <div>
                  <div className="flex justify-between text-xs font-medium text-[#86868b] mb-1.5">
                  ...
                  <div className="h-3 w-full bg-[#f5f5f7] rounded-full overflow-hidden p-0.5">
                    <div className="h-full bg-[#86868b]/30 rounded-full w-[22%]" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="absolute -bottom-10 -right-10 w-60 h-60 bg-blue-50 rounded-full blur-3xl pointer-events-none opacity-60" />
          </div>

          {/* Tile 2: Zero-Knowledge (5 cols) */}
          <div className="md:col-span-5 rounded-[28px] border border-black/[0.06] bg-white p-8 sm:p-10 shadow-[0_10px_30px_rgba(0,0,0,0.04)] flex flex-col justify-between overflow-hidden relative">
            <div className="space-y-2 z-10">
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-50 text-[11px] font-semibold text-emerald-700">
            ...
            <div className="mt-8 pt-6 border-t border-black/[0.06] z-10">
              <div className="flex items-center justify-between p-3.5 rounded-2xl bg-[#f5f5f7] border border-black/[0.04]">
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-xl bg-white shadow-sm flex items-center justify-center text-emerald-600">
                    <KeyRound className="h-4 w-4" />
                  </div>
                  <div>
                    <div className="text-xs font-semibold text-[#1d1d1f]">AES-256-GCM</div>
                    <div className="text-[10px] text-[#86868b] font-mono truncate max-w-[140px]">
                      hash: 9f8a...4b12
                    </div>
                  </div>
                </div>
          ...
          <div className="md:col-span-5 rounded-[28px] border border-black/[0.06] bg-white p-8 sm:p-10 shadow-[0_10px_30px_rgba(0,0,0,0.04)] flex flex-col justify-between overflow-hidden relative">
            <div className="space-y-2 z-10">
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-50 text-[11px] font-semibold text-amber-800">
            ...
            <div className="mt-8 pt-6 border-t border-black/[0.06] z-10">
              <div className="grid grid-cols-4 gap-1.5 p-1 bg-[#f5f5f7] rounded-xl">
                {[
                  { id: "10m", label: "10 dk" },
                  { id: "1h", label: "1 saat" },
              ...
              <div className="text-[11px] text-center text-[#86868b] mt-2.5">
                {selectedExpiry === "burn"
          ...
          <div className="md:col-span-7 rounded-[28px] border border-black/[0.06] bg-white p-8 sm:p-10 shadow-[0_10px_30px_rgba(0,0,0,0.04)] flex flex-col justify-between overflow-hidden relative">
            <div className="space-y-2 z-10">
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-purple-50 text-[11px] font-semibold text-purple-700">
            ...
            {/* Platform Badges */}
            <div className="mt-8 pt-6 border-t border-black/[0.06] z-10 flex flex-wrap items-center gap-3">
              {["iOS & iPadOS", "macOS", "Android", "Windows 11", "Linux"].map((platform) => (
                <span
                  key={platform}
                  className="px-3.5 py-1.5 rounded-full bg-[#f5f5f7] text-xs font-semibold text-[#1d1d1f] border border-black/[0.04]"
                >
                  {platform}
                </span>
              ))}
