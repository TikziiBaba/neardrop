...
function ResetPasswordContent() {
  ...
  useEffect(() => {
    ...
    // Give a short grace period for token hash parsing from URL
    ...
    <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center p-4 sm:p-8 relative">
      ...
      <div className="relative w-full max-w-md space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-bold tracking-tight text-white">Yeni Şifre Belirleyin</h1>
          ...
          {isSuccess ? (
            <div className="text-center space-y-4 py-3">
              ...
              <div className="space-y-1">
                <h3 className="text-base font-semibold text-white">Şifreniz Değiştirildi!</h3>
                <p className="text-xs text-zinc-400">
                  Yeni şifreniz başarıyla kaydedildi. Artık yeni şifrenizle giriş yapabilirsiniz.
                </p>
              </div>
              <Link href="/login">
                <Button variant="primary" className="w-full mt-2 gap-2 py-2.5">
                  <span>Giriş Yap</span>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-semibold text-zinc-300">Yeni Şifre</label>
              ...
              {/* Confirm Password */}
              <div className="space-y-1.5">
                <label className="text-xs font-semibold text-zinc-300">Yeni Şifreyi Onaylayın</label>
                <div className="relative">
                  <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-zinc-500" />
                  <Input
              ...
              <Button
                ...
                variant="primary"
                disabled={isLoading}
                className="w-full gap-2 py-2.5 mt-2 shadow-lg shadow-sky-500/25"
              >
                {isLoading ? (
                  <>
