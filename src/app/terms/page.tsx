        ...
        <div className="space-y-10 text-sm sm:text-base leading-relaxed text-zinc-300">
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc list-inside space-y-2 text-sm text-zinc-300 ml-2">
              <li>Uploading or distributing illegal, copyrighted, or malicious software/files.</li>
              <li>Hosting malware, viruses, phishing kits, or ransomware.</li>
              <li>Interfering with infrastructure security or attempting denial-of-service.</li>
            </ul>
          </section>
